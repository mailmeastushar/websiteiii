...
<div class="container">
  <form method="post" action="{{ url('updatelatestupdate') }}" enctype="multipart/form-data"> 
  	{{ csrf_field() }}
    ...
    <input type="text" class="button_title" name="button_title" value="{{ $data['button_title'] }}"><br>
    <label for="fname">Short Description (Max Length: 250)</label><br>
    <input type="text" class="short_description" name="short_description" maxlength="245" value="{{ $data['short_description'] }}"><br>
