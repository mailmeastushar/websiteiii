...
@section("meta_title","Calculate your CRS Score to Apply for the PR Visa in Canada.")
@section("meta_description","Triple I Business provides a full detailed report of your profile to apply for the Permanent Residence visa in Canada.")
@section('container')
...
@endforeach
<style>
   .gradient_bc .card .card-block {
   min-height: 284px;
   }
   .about_custom.crspont p {
   margin-top: 16px;
   margin-bottom: 16px;
   }
   .about_custom.crspont h6 {
   font-size: 20px;
   }
   .size-30 {
         ...
         <div class="col-md-4 col-xl-3">
            <div class="card bg-c-blue order-card">
               <div class="card-block">
                  ...
                  <p >Our consultants have rich experience in helping candidates immigrating abroad. Schedule a free consultation to learn how we can help you to immigrate</p>
               </div>
            </div>
         </div>
         <div class="col-md-4 col-xl-3">
            <div class="card bg-c-green order-card">
               <div class="card-block">
                  ...
                  <center class="mb-3" ><img src="{{ asset('public/assets') }}/images/r2.png" style="width:34%;" class="img-responsive" alt="Triple I Business Image"></center>
                  <p>Don’t spend hours searching through articles on the internet. Know the detailed steps to apply by consulting our immigration experts</p>
               </div>
            </div>
         </div>
         <div class="col-md-4 col-xl-3">
         ...
         <div class="col-md-4 col-xl-3">
            <div class="card bg-c-pink order-card">
               <div class="card-block">
                  ...
                  <center class="mb-3"><img src="{{ asset('public/assets') }}/images/r4.png" style="width:47%;" height="60" class="img-responsive" alt="Triple I Business Image"></center>
                  <p>Our relation doesn't end by getting you the visa. Our team is committed to helping you with every step of the immigration process till the Visa is in your hand</p>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="crs_button">
               <a href="https://www.tripleibusiness.com/assessment" style="text-decoration: none"><button class="more" style="color: #fff;font-weight: bold;font-size: 1.2em;">APPLY NOW</button></a>
            </div>
         </div>
      </div>
   </div>
