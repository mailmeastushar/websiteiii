...
<div>
	<img src="{{ asset('public/assets/images/'.$data['image'] )}}" class="img-responsive" style="width: 100%" height="auto" alt="{{ $data['alt'] }}">
</div>
...
<div id="header">
    <a href="#" id="closeicon"><img src="{{ asset('public/assets/user') }}/images/close-icon.png" class="img-responsive" width="25" alt="Triple I Business Image"></a>
<h4>Contact Here</h4>
...
</div><div class="card-deck flag_custom1 ">
<div class="card">
...
<div class="card-body">
<center><a href="{{ url('front_flag/CANADA') }}"><h5 class="card-title">CANADA</h5></a></center>
...
<div class="card-body">
<center><a href="{{ url('front_flag/AUSTRALIA') }}"><h5 class="card-title">AUSTRALIA</h5></a></center>
...
<div class="card-body">
<center> <a href="{{ url('front_flag/GERMANY') }}"><h5 class="card-title">GERMANY</h5></a></center>
...
<div class="card-body">
<center><a href="{{ url('front_flag/UK') }}"><h5 class="card-title">UK</h5></a></center>  
...
<a href=""><img class="card-img-top avatar" src="{{ asset('public/assets/user') }}/images/austrlia.png" class="img-responsive" alt="Card image cap"></a>
<div class="card-body">
<center> <a href="{{ url('front_flag/NEW%20ZEALAND') }}"><h5 class="card-title">NEW ZEALAND</h5></a></center>
</div>
</div> 
</div>
...
<p class="mb-2" style="color: #8a8181;font-size: 1rem;font-weight: bold"><i class="fa fa-clock-o" aria-hidden="true"></i> Monday to saturday- 9AM to 6PM</p>
...
<span><a href="{{ url('assessment/') }}"><button class="more" style="color: #fff;font-weight: bold;font-size: 1.2em;text-decoration: none">APPLY NOW</button></a></span>
